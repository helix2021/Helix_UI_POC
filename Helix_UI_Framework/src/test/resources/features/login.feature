...
Given User is on Helix login page
Then Forgot your password link should be displayed as "Forgot Your"
#
#
#
...
#|Biohaven Speaker Bureau | mcorry@scimedny.com |Test123 |Welcome, Merrilltrhtrh |